...
/*
* Generated based on TallyConnector.Models.Base.TallyObject
*/
partial class TallyObject : global::TallyConnector.Core.Models.Interfaces.ITallyRequestableObject
{
    ...
    const string ReportName = "TallyObject_IBBN";
    const string CollectionName = "TallyObjectsCollection_IBBN";
    const string XMLTag = "TALLYOBJECT";
    const int SimpleFieldsCount = 6;
    ...
    public static global::System.Xml.Serialization.XmlAttributeOverrides GetXMLAttributeOverides()
    {
        ...
        xmlAttributeOverrides.Add(TallyConnector.Core.Models.Response.ReportResponseEnvelope<global::TallyConnector.Models.Base.TallyObject>.TypeInfo, "Objects", XmlAttributes);
    ...
    {
        return new(ReportName, [GUID_QW2F_FieldName,RemoteId_4JMJ_FieldName,MasterId_2JFP_FieldName,AlterId_RUKQ_FieldName,EnteredBy_WTJ3_FieldName,AlteredBy_K5HW_FieldName], XMLTag);
    }
    ...
    internal static global::TallyConnector.Core.Models.Request.Collection[] GetTDLCollections()
    {
        ...
        collections[0] = new(CollectionName, "TALLYOBJECT", nativeFields: [..GetFetchList()]);
        return collections;
    }

    internal static string[] GetFetchList()
    {
        return["REMOTEALTGUID", "ALTERID", "ENTEREDBY", "ALTEREDBY"];
    }
}