...
public class BasicIntegrationTests
{
    ...
    public async Task TestEnum()
    {
        ...
        var groupEnums = await tallyServiceTestEnum.GetGroupsAsync(new());
    ...
    [TestMethod]
    public async Task GetVouhers()
    {
        var paginatedResponse = await  new TallyServiceTestEnum().GetTestVouchersAsync(new PaginatedRequestOptions() { FromDate=new DateTime(2022,4,1), ToDate = new DateTime(2023, 3, 31),Childof="Contra" });
    }
}
...
[TallyConnector.Core.Attributes.GenerateHelperMethod<TestVoucher>]
...
[TDLCollection(Type ="Vouchers:VoucherType")]
public class TestVoucher : TallyObject, IBaseVoucherObject
{
