...
//        Lines = new() { new(lineName, LF, rightFields: RF) };
//        Fields = new();
...
//    {
//        Report = new(reportName, reportName);

//        Form = new(reportName, reportName, reportName);
//        Part = new(reportName, colName, reportName);
//        Lines = new() { new(reportName, fields.Select(c => c.Name).ToList(),xmlTag: reportName),  };
...
//{
//    public Line(string lineName, List<string> leftFields, string xmlTag=null, List<string> rightFields = null)
//    {
//        Name = lineName;
...
//        SetAttributes();
//    }
//    public Field(string name, string set, string xMLTag)
//    {
//        XMLTag = xMLTag;
//        Set = set;
//        Name = name;
